(function(){if(window.DMP_CONTEXT===undefined){window.DMP_CONTEXT={__version__:'4.4.3',contexts:{},contextsByName:{},set:function(version,contextid,data){if(DMP_CONTEXT.__version__!=version){console.warn('DMP framework version is '+version+', while dmp-common.js is '+DMP_CONTEXT.__version__+'. Unexpected behavior may occur.');}
