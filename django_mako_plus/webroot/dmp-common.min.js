...
window.DMP_CONTEXT={__version__:'5.9.4',contexts:{},contextsByName:{},lastContext:null,bundleFunctions:{},logEnabled:null,set:function(context){DMP_CONTEXT.logEnabled=DMP_CONTEXT.logEnabled||context.log;if(DMP_CONTEXT.__version__!=context.version){DMP_CONTEXT.log(['server version',context.version,'is different from dmp-common.js',DMP_CONTEXT.__version__,'- unexpected behavior may occur']);}
