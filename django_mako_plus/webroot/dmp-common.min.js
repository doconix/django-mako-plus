...
window.DMP_CONTEXT={__version__:'5.7.21',contexts:{},contextsByName:{},lastContext:null,bundleFunctions:{},logEnabled:null,set:function(version,contextid,data,templates){DMP_CONTEXT.logEnabled=DMP_CONTEXT.logEnabled||data.__router__.log;if(DMP_CONTEXT.__version__!=version){DMP_CONTEXT.log(['Framework version on server is',version,' but dmp-common.js is',DMP_CONTEXT.__version__,'- unexpected behavior may occur.']);}
