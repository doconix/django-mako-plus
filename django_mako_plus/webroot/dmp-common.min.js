(function(){if(window.DMP_CONTEXT===undefined){window.DMP_CONTEXT={__version__:'4.3.2',contexts:{},contextsByName:{},set:function(version,contextid,data){if(DMP_CONTEXT.__version__!=version){console.warn('DMP framework version is '+version+' dmp-common.js is '+DMP_CONTEXT.__version__+'. Unexpected behavior may occur.');}
DMP_CONTEXT.contexts[contextid]=data;},addScript:function(uid,contextid,template,src,async){if(DMP_CONTEXT.contextsByName[template]===undefined){DMP_CONTEXT.contextsByName[template]=[];}
DMP_CONTEXT.contextsByName[template].push(contextid);var n=document.createElement("script");n.id=uid;n.async=async;n.setAttribute('data-template',template);n.setAttribute("data-context",contextid);n.src=src;if(document.currentScript){document.currentScript.parentNode.insertBefore(n,document.currentScript.nextSibling);}else{document.head.appendChild(n);}},get:function(option){var ret=DMP_CONTEXT.getAll(option);if(ret.length==0){return undefined;}
