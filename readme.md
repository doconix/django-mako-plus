...
- [Tutorial](#tutorial)
	...
	- [this is the skeleton of all pages on in this app - it defines the basic html tags](#this-is-the-skeleton-of-all-pages-on-in-this-app-it-defines-the-basic-html-tags)
	- [imports](#imports)
...
- [this works in any app/views/*.py file:](#this-works-in-any-appviewspy-file)
- [this also works in any app/views/*.py file:](#this-also-works-in-any-appviewspy-file)
...
- [return a custom error page](#return-a-custom-error-page)
...
- [return a normal redirect with Django from a process_request method](#return-a-normal-redirect-with-django-from-a-processrequest-method)
- [return a Javascript-based redirect from a process_request method](#return-a-javascript-based-redirect-from-a-processrequest-method)
- [raise a normal redirect from anywhere in your code](#raise-a-normal-redirect-from-anywhere-in-your-code)
- [raise a permanent redirect from anywhere in your code](#raise-a-permanent-redirect-from-anywhere-in-your-code)
- [raise a Javascript-based redirect from anywhere in your code](#raise-a-javascript-based-redirect-from-anywhere-in-your-code)
- [restart the routing process with a new view without returning to the browser.](#restart-the-routing-process-with-a-new-view-without-returning-to-the-browser)
- [the browser keeps the same url and doesn't know a redirect has happened.](#the-browser-keeps-the-same-url-and-doesnt-know-a-redirect-has-happened)
- [the request.dmp_router_module and request.dmp_router_function variables are updated](#the-requestdmproutermodule-and-requestdmprouterfunction-variables-are-updated)
- [to reflect the new values, but all other variables, such as request.urlparams,](#to-reflect-the-new-values-but-all-other-variables-such-as-requesturlparams)
- [request.GET, and request.POST remain the same as before.](#requestget-and-requestpost-remain-the-same-as-before)
- [the next line is as if the browser went to /homepage/upgrade/](#the-next-line-is-as-if-the-browser-went-to-homepageupgrade)
...
- [Advanced Topics](#advanced-topics)
	...
	- [imports](#imports)
	- [render the css with the same name as this page](#render-the-css-with-the-same-name-as-this-page)
	- [render the JS with the same name as this page](#render-the-js-with-the-same-name-as-this-page)
...
- [see what would be be done without actually deleting any cache folders](#see-what-would-be-be-done-without-actually-deleting-any-cache-folders)
- [really delete the folders](#really-delete-the-folders)
- [see what would be be done without actually deleting anything](#see-what-would-be-be-done-without-actually-deleting-anything)
- [really delete the files](#really-delete-the-files)
...
```
python3 -m django startproject --template=https://github.com/doconix/django-mako-plus/tree/master/project_template.zip test_dmp
```
...
```python
python3 manage.py startapp --template=https://github.com/doconix/django-mako-plus/tree/master/app_template.zip --extension=py,htm,html homepage
```
