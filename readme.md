...
> Python programmers usually use TitleCaseClassName (capitalized words) for class names.  In the above classes, I'm naming them all lowercase so my URL doesn't have uppercase characters in it.  If you'd rather use TitleCaseClassName, just be sure to match it in your URL.
