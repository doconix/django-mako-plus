...
&lt;img src=&quot;{% get_static_prefix %}images/hi.jpg&quot;/&gt;</code></pre></td>
    ...
    <td colspan="2"><b>Call a Python method:</b></td>
  </tr><tr>
...
<pre><code>&nbsp;&nbsp;${ value if value != None else "nothing" }</code></pre>
    ...
    <td colspan="2"><b>Run arbitrary Python (keep it simple, Tex!):</b></td>
  </tr><tr>
...
%&gt;</code></pre></td>
    ...
    <td colspan="2"><b>Link to a CSS file:</b></td>
  </tr><tr>
    <td>Place in each template:
<pre><code>&nbsp;&nbsp;&lt;link rel=&quot;stylesheet&quot; type=&quot;text/css&quot; href=&quot;...&quot;&gt;</code></pre></td>
    <td>Simply name the .css/.js file the same name as your .html template.  DMP will include the link automatically.</b></td>
  </tr><tr>
    <td colspan="2"><b>Perform per-request logic in CSS or JS files:</td>
  </tr><tr>
